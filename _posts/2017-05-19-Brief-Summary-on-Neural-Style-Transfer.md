...
<figure class="left-align quarter-width">
  ![](/content/img/2017/05/17/1.png)
	<figcaption>
	  Figure 1 Artistic Style Transfer. From left to right: content image, style image, transferred result
	</figcaption>
</figure>
